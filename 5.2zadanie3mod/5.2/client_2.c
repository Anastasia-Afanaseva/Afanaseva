...
int main()
{
    ...
    struct sockaddr_in cliaddr_1, cliaddr_2; /* Структуры для адресов клиента и собеседника */
    ...
    cliaddr_2.sin_addr.s_addr = htonl(INADDR_ANY);

    /* Настраиваем адрес сокета */
    if(bind(sockfd, (struct sockaddr *) &cliaddr_2, sizeof(cliaddr_2)) < 0)
    {
        perror(NULL);
    ...
    if(inet_aton("127.0.0.1", &cliaddr_1.sin_addr) == 0)
    {
